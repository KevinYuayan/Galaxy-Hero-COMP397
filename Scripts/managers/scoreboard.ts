...
module managers {
    export class ScoreBoard {
         ...
         */
        constructor(livesNum:number = 5, scoreNum:number = 0, highScoreNum:number = 0, bombsNum = 1,level:number = 0){
        ...
        public Reset(livesNum:number = 5, scoreNum:number = 0, bombsNum = 1,level:number = 0): void {
            this.Lives = livesNum;
            this.Score = scoreNum;
            this.Bombs = bombsNum;
            this.Level = level;
